...
execute @e[tag=starting_race,scores={race_start=150}] ~ ~ ~ execute @e[type=cg:race_light_marker,r=20] ~ ~ ~ setblock ~ ~ ~ minecraft:coal_block
execute @e[tag=starting_race,scores={race_start=150}] ~ ~ ~ tag @s remove starting_race